  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            icon: Icon(Icons.broken_image_outlined,size: 30,),
            onPressed: () {},
          ),
          IconButton(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        actionButton(
                            Icons.videocam, "Đăng video", Colors.pinkAccent,22.0),
            ...
            feedBox(avatarUrl[1], "Mai Thu Trang", "6 min",
                "Yêu anh Tuấn vãi", storyUrl[2]),
            feedBox(avatarUrl[2], "Nguyễn Quý Phúc", "Yesterday",
                "Anh Tuấn là sư phụ của em", storyUrl[1]),
          ],
        )
      ),
